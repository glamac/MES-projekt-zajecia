...
namespace MES {
    struct ShapeFunctions {
        ...
        // Returns a four-element vector containing all the shape functions N1 through N4 for this point.
        Matrix constexpr static NMatrix(real_t ksi, real_t eta) {
            return Matrix(4, 1, {
        ...
        // Returns a four-element vector containing all the shape functions N1 through N4 for this point.
        Matrix constexpr static NMatrix(node p) {return NMatrix(p.ksi, p.eta);};
        struct dKsi {
            ...
            Matrix constexpr static NMatrix(real_t eta) {
                return Matrix(4, 1, {
            ...
            Matrix constexpr static NMatrix(node p) {return NMatrix(p.eta);};
        };
        struct dEta {
            ...
            Matrix constexpr static NMatrix(real_t ksi) {
                return Matrix(4, 1, {
            ...
            Matrix constexpr static NMatrix(node p) {return NMatrix(p.ksi);};
        };
    };
}
